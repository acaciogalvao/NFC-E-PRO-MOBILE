...
/** 
 * ALÍQUOTAS DE ALTA PRECISÃO (IBPT)
 * Para Base R$ 922,07:
 * Federal (5,7631%) -> R$ 53,1399... -> Round -> R$ 53,14
 * Estadual (20,1081%) -> R$ 185,410... -> Round -> R$ 185,41
 */
const DEFAULT_PRECISION_TAX = { federal: '5,7631', estadual: '20,1081', municipal: '0,0000' };
...
export const BLANK_INVOICE: InvoiceData = {
  ...
  impostos: { ...DEFAULT_PRECISION_TAX },
  detalheCodigo: '',
  bico: ''
};
...
export const DEFAULT_LAYOUTS: LayoutConfig[] = [
  {
    ...
    upperCaseAll: false, // ALTERADO: Permite letras minúsculas (Misto)
    lineSpacing: 'TIGHT',
    density: 'COMPACT',
    customTexts: {
      ...
      footerMessage: '', // REMOVIDO: Texto abaixo do QR Code
      extraNotes: ''
    }
  },
  {
...
export const ICCAR_DEFAULT_MODEL: SavedModel = {
  ...
  taxRates: { ...DEFAULT_PRECISION_TAX },
  prices: [
